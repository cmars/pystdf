...
from pystdf.oo_helpers import abstract
...
class MaterialIndexer:
    ...
    def before_send(self, dataSource, data):
        ...
        if isinstance(recType, v4.Pir):
            ...
            headSite = (
                fields[v4.Wir.HEAD_NUM],
                None,
            )  # fields[v4.Wir.SITE_NUM] Does not exist
            self.onWir(headSite)
    ...
    def after_send(self, dataSource, data):
        ...
        if isinstance(recType, v4.Prr):
            ...
            headSite = (
                fields[v4.Wrr.HEAD_NUM],
                None,
            )  # fields[v4.Wrr.SITE_NUM] Does not exist
            self.onWrr(headSite)
